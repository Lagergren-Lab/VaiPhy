...
out_file = open(orig_results_path + 'vaiphy_synthetic_output.tsv', 'wt')
                        ...
                        for ng in ["0.8"]:
                            for n_particle in n_particles_list:
                                for vaiphy_seed in vaiphy_seed_list:
                                    results_path = orig_results_path + "data_seed_" + str(data_seed) \
                                                   + "_taxa_" + str(n_taxa) + "_pos_" + str(n_pos) + "/"
