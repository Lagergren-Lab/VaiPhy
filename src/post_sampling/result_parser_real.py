...
out_file = open(orig_results_path + 'csmc_real_output.tsv', 'wt')
tsv_writer = csv.writer(out_file, delimiter='\t')
headers = ["data_seed", "taxa", "pos", "n_particles", "vaiphy_seed", "NG",
                                    ...
                                    for n_csmc_particle in n_csmc_particle_list:
                                        for csmc_merger in csmc_merger_list:
                                            for csmc_branch in csmc_branch_list:
                                                ...
                                                tsv_writer.writerow([data_seed, n_taxa, n_pos, n_particle, vaiphy_seed, ng,
